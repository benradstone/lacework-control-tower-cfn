...
- [Support docs on docs.lacework.com](https://docs.lacework.net/onboarding/aws-config-and-cloudtrail-integration-with-aws-control-tower-using-cloudformation#troubleshooting)
